...
inline void packFloatsAndIndicesInUint64(float* __restrict values, unsigned long long* __restrict keys, unsigned count) {
	__m256i i0 = _mm256_setr_epi32(0, 1, 2, 3, 4, 5, 6, 7);
	__m256i i1 = _mm256_setr_epi32(8, 9, 10, 11, 12, 13, 14, 15);
	__m256i i2 = _mm256_setr_epi32(16, 17, 18, 19, 20, 21, 22, 23);
	__m256i i3 = _mm256_setr_epi32(24, 25, 26, 27, 28, 29, 30, 31);
	...
	for (; i < count; ++i) {
		...
		keys[i] = ((unsigned long long)input << 32) | i;
	}
}
...
void sortedIndicesFromFloatsX3(float* __restrict valuesA, float* __restrict valuesB, float* __restrict valuesC, unsigned* __restrict indicesA, unsigned* __restrict indicesB, unsigned* __restrict indicesC, unsigned count) {
	...
	packFloatsAndIndicesInUint64(valuesA, keysA, count);
	packFloatsAndIndicesInUint64(valuesB, keysB, count);
	packFloatsAndIndicesInUint64(valuesC, keysC, count);
