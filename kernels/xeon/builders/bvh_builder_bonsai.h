  ...
  {  
    ...
    template<typename BuildRecord, 
      ...
      public:
		...
		/*! mini tree select */
		  BBox3fa computeMidPointBounds(size_t first, size_t last) {
			  BBox3fa bounds;
			  for (size_t i = 0; i < last; i++) {
				  bounds.extend(pinfo[i].centBounds);
			  }
		  }
		  
		  void miniTreeSelectRescursive() {
		  
			  // if count < MAX SIZE
			  // return
			  computeMidPointBounds();
			  //partition
		  }
